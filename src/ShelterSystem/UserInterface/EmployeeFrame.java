...
public class EmployeeFrame extends JFrame {
    ...
    private JMenuItem changeInformation;    //"修改密码"菜单项。
    ...
    public void run() {
        ...
        queryUser.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TODO
                QueryFrame queryFrame = new QueryFrame(jf, "查询用户信息", true, "User");
            }
        });
...
//        userManager.add(modifyUser);
        ...
        addAnimal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TODO
                AddAnimalFrame addStudentFrame = new AddAnimalFrame(jf, "添加动物", true);
            }
        });
        ...
        queryAnimal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TODO
                QueryAnimalFrame queryStudentFrame = new QueryAnimalFrame(jf, "查询动物信息", true);
            }
        });
